...
(function($) {
    ...
    var blog = {
		...
		BannerRightSlider:function(){
			new Swiper('.my_banner_slider_right_vertical .swiper-container', {
				spaceBetween: 20,
				direction:'vertical',
				slidesPerView: 3,
				loop: true, 
...
$(document).ready(function(){
	...
	$('.mySwipSlide').slick({
		...
		slidesToScroll: 1,
		autoplay: true,
		prevArrow: '.worldnews-swiper-button-prev',
		nextArrow: '.worldnews-swiper-button-next',
		autoplaySpeed: 1500,
	  });
	...
	$(window).scroll(function(){
		if ($(window).scrollTop() >= 150) {
			$('#my-stickyy').addClass('sticky_headd');
		}
		else {
			$('#my-stickyy').removeClass('sticky_headd');
		}
	});
  });
